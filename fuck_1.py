...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mTools  \033[1;31m   ● \x1b[38;5;46mRNDM/CLONING
...
def v2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=20) as akash:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        ...
        for guru in user:
            ...
            pwx = [kode+kodex+kod+guru,kod+guru,kodex+guru,kode+kodex+kod,'FreeFire','Pubg123','Bangladesh','sadiya','jannat','sumaiya','tamanna','khadija','sultana']
